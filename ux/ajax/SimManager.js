...
Ext.define('Ext.ux.ajax.SimManager', {
    ...
    init: function (config) {
        ...
        if (!me.ready) {
            ...
            me._request = Ext.data.Connection.prototype.request;
            ...
            Ext.data.Connection.override({
                request: function(options) {
                    ...
                    if (me.fireEvent('beforerequest', me, options) !== false) {
                        ...
                        xhr = !options.nosim &&
                            simManager.getXhr(requestOptions.method, requestOptions.url, options, async);
                        if (!xhr) {
                            xhr = this.getXhrInstance();
                        }
                ...
                /*
                request: function (options, requestOptions, async) {
    ...
    request: function (method, url, async) {
        ...
        return this._request.call(Ext.data.Connection.prototype, {}, opt, async);
    },
